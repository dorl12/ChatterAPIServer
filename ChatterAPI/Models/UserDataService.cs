    ...
    public class UserDataService
    {
        ...
        public static List<UserChats> _AllUsersChats = new List<UserChats>(){
            new UserChats() { Username = "or", Chats = new List<Chat>(){
                            new Chat() {
                                ContactUserName = new Contact() { id = "yotam", name = "Yotam Levin", server = "localhost:7265", last = "I'm good, wanna play volleyball?", lastdate = new DateTime(2008, 5, 1, 8, 30, 52) }, 
                            ...
                            new Chat() {
                                ContactUserName = new Contact() { id = "dor", name = "Dor Levi", server = "localhost:7265", last = "I'm good!!!!!!!!", lastdate = new DateTime(2008, 5, 1, 8, 30, 52) },
                                Messages = new List<Message>()
            ...
            new UserChats() { Username = "yotam", Chats = new List<Chat>(){
                            new Chat() {
                                ContactUserName = new Contact() { id = "or", name = "OrDrukman", server = "localhost:7265", last = "I'm good, wanna play volleyball?", lastdate = new DateTime(2008, 5, 1, 8, 30, 52) },
                                Messages = new List<Message>()
